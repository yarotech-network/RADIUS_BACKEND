...
ROUTER_SELF_SERVICE_PROVISIONING_ENABLED = config('ROUTER_SELF_SERVICE_PROVISIONING_ENABLED', default=False, cast=bool)
WG_VPS_ENDPOINT = config('WG_VPS_ENDPOINT', default='')
WG_VPS_PUBLIC_KEY = config('WG_VPS_PUBLIC_KEY', default='')
WG_ENDPOINT_PORT = config('WG_ENDPOINT_PORT', default=51820, cast=int)
RADIUS_SERVER_WG_IP = config('RADIUS_SERVER_WG_IP', default='')
ROUTER_RADIUS_AUTH_PORT = config('ROUTER_RADIUS_AUTH_PORT', default=1812, cast=int)
ROUTER_RADIUS_ACCT_PORT = config('ROUTER_RADIUS_ACCT_PORT', default=1813, cast=int)
ROUTER_WIREGUARD_SERVICE_CIDRS = config('ROUTER_WIREGUARD_SERVICE_CIDRS', default='')
...
WHATSAPP_WEBHOOK_ENABLED = config('WHATSAPP_WEBHOOK_ENABLED', default=False, cast=bool)
WHATSAPP_GRAPH_VERSION = config('WHATSAPP_GRAPH_VERSION', default='')
WHATSAPP_CONSUMER_ENABLED = config('WHATSAPP_CONSUMER_ENABLED', default=False, cast=bool)
WHATSAPP_SEND_ENABLED = config('WHATSAPP_SEND_ENABLED', default=False, cast=bool)
WHATSAPP_WEBHOOK_VERIFY_TOKEN = config('WHATSAPP_WEBHOOK_VERIFY_TOKEN', default='')
WHATSAPP_TENANT_ROUTING_SIGNING_KEY = config('WHATSAPP_TENANT_ROUTING_SIGNING_KEY', default='')
WHATSAPP_SENDER_HASH_KEY = config('WHATSAPP_SENDER_HASH_KEY', default='')
